...
public class PromptUtils {
    ...
    public static String buildSystemPrompt(String context, String recentConversation) {
        ...
        return "You are an OSRS RuneLite assistant. Use OSRS knowledge and treat GAME CONTEXT and tools as truth.\n"
                ...
                + "14. Verify exact Herblore potion level requirements and recipes, spell rune requirements, item slots, and gear mechanics before giving advice (e.g. Antifire potion requires level 69 Herblore and Lantadyme + Dragon scale dust, NOT Harralander/level 34; Ice Spells require Water/Chaos/Death/Blood runes, not Air runes; Tome of Fire is a shield-slot off-hand item, not a staff; staff melee stats are negligible and not used for melee combat).\n"
