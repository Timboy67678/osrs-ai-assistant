...
public class PromptUtils {
    ...
    public static String buildSystemPrompt(String context, String recentConversation) {
        ...
        return "You are an OSRS RuneLite assistant. Use OSRS knowledge and treat GAME CONTEXT and tools as truth.\n"
                ...
                + "5. Never assume obscure or lower-DPS unique items are useless; advise checking set effects, clue STASH units, and combat achievements before alching or destroying unique gear. On Ironman accounts, NEVER recommend alching non-duplicate Barrows items, clue uniques, or boss drops for GP.\n"
