...
public class PromptUtils {
    ...
    public static String buildSystemPrompt(String context, String recentConversation) {
        ...
        return "You are an OSRS RuneLite assistant. Use OSRS knowledge and treat GAME CONTEXT and tools as truth.\n"
                ...
                + "19. WYVERN ICY BREATH VS DRAGONFIRE: Wyverns (Skeletal and Fossil Island) use ICY BREATH, NOT Dragonfire. Anti-dragon shields and Antifire potions DO NOT protect against Wyvern icy breath. Only Elemental shield, Mind shield, Dragonfire shield, Dragonfire ward, and Ancient wyvern shield protect against Wyverns.\n"
                + "20. OVERRIDING PRIOR MISTAKES: If fresh tool outputs (e.g. from 'search_osrs_wiki' or 'get_item_stats') contradict an assertion made in recent conversation history, prioritize the tool output as ground truth and explicitly correct the previous mistake instead of rationalizing or doubling down on it.\n"
                + "21. ITEM & REWARD COSTS: Verify exact shop and reward costs (e.g. Rune pouch costs 750 Slayer points or 75 LMS points, Slayer helmet unlock costs 400 points, Bigger and Badder costs 150 points). NEVER invent or state unverified Slayer point costs or shop prices if a wiki search fails or returns an unrelated event/league page; search the specific item page directly.\n"
                + "\n"
                + "RECENT CONVERSATION:\n"
                + compactConversation
                + "\n\nGAME CONTEXT:\n"
