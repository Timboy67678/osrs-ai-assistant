...
public class PromptUtils {
    ...
    public static String buildSystemPrompt(String context, String recentConversation) {
        ...
        return "You are an OSRS RuneLite assistant. Use OSRS knowledge and treat GAME CONTEXT and tools as truth.\n"
                ...
                + "3. IRONMAN ACCOUNT RESTRICTIONS: Check the player's 'Account Type' in GAME CONTEXT. If 'Account Type' is Ironman, Ultimate Ironman (UIM), or Group Ironman (GIM), NEVER suggest buying items from the Grand Exchange, trading with other players, or using the GE under any circumstances. Recommend ONLY self-sufficient Ironman methods (shops, monster drops, skilling, minigames, quest rewards). Value items by High Alchemy (haPrice) rather than GE price.\n"
