...
/**
 * Strategy interface defining API-specific payload construction, response
 * parsing,
 * tool call extraction, and HTTP request building for AI model providers.
 */
public interface ProviderHandler {
        /**
         * Constructs the JSON request payload for sending a user question and
         * conversation context to the AI API.
         *
         * @param modelId            the API model identifier (e.g. "gpt-4o",
         ...
         * @param shareCharInfo      {@code true} if character information and tools
         *                           requiring character state are enabled
        ...
        /**
         * Updates the request body with assistant tool calls and corresponding tool
         * execution results for follow-up API turns.
         *
        ...
        /**
         * Builds an HTTP {@link Request} object configured with headers,
         * authentication, URL, and body for sending to the provider API.
         *
