...
public class OpenAiProviderHandlerTest {
    ...
    @Test
    public void testBuildRequestBodySetsMaxTokens() {
        ...
        Assert.assertEquals(4096, body.get("max_tokens").getAsInt());
        Assert.assertTrue(body.has("max_completion_tokens"));
        Assert.assertEquals(4096, body.get("max_completion_tokens").getAsInt());
    }
